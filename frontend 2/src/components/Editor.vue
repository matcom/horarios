            ...
            <div class='row'>
              <div class='col-3'>
                <div class='dropdown mb-0'>
                  <button class='btn btn-light dropdown-toggle' type='button' id='asignaturas_drop_down'
              ...
              <div class='col-3'>
                <div class='dropdown mb-0'>
                  <button class='btn btn-light dropdown-toggle' type='button' id='locales_drop_down'
                          data-toggle='dropdown' aria-haspopup='true' aria-expanded='true'>
                    Locales
                  </button>
                  <div class='dropdown-menu animated--fade-in ' aria-labelledby='dropdownMenuButton'
              ...
              <div class='col-3'>
                <div class='dropdown mb-0'>
                  <button class='btn btn-light dropdown-toggle' type='button' id='resources_drop_down'
                          data-toggle='dropdown' aria-haspopup='true' aria-expanded='true'>
                    Recursos
                  </button>
                  <div class='dropdown-menu animated--fade-in ' aria-labelledby='dropdownMenuButton'
              ...
              <div class='col-3'>
                <div class='dropdown mb-0'>
                  <button class='btn btn-light dropdown-toggle' type='button' id='tipos_drop_down'
                          data-toggle='dropdown' aria-haspopup='true' aria-expanded='true'>
                    Tipos
                  </button>
                  <div class='dropdown-menu animated--fade-in ' aria-labelledby='dropdownMenuButton'
